...
- Ubuntu; Java 21 (Minecraft 1.21.x requires JDK 21) and Gradle 9.3.0.
...
- Steps:
  - Run semantic-release in `mods/<modid>` to compute next version from Angular commits, update
    `gradle.properties`, generate changelog, tag `<modid>-vX.Y.Z`, and create a draft release.
...
- Java toolchain set to 21 in modules; CI uses Java 21 and Gradle 9.3.0.
