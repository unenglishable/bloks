...
- [ci.yml](.github/workflows/ci.yml) PR/branch build + remapJar (Java 21, Gradle 9.3.0), versions from `.tool-versions`
...
2) Ensure `java -version` reports 21.x; install Gradle (9.3.0) and Node per `.tool-versions` via asdf.
