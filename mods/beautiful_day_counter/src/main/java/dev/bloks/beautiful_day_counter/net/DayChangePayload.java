...
public record DayChangePayload(long day) implements CustomPayload {
  public static final Id<DayChangePayload> ID =
      new Id<>(Identifier.of(BeautifulDayCounter.MOD_ID, "day_change"));
  public static final PacketCodec<PacketByteBuf, DayChangePayload> CODEC =
      PacketCodec.of(DayChangePayload::write, DayChangePayload::read);
